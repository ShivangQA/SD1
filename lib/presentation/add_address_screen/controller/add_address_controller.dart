import '/core/app_export.dart';import 'package:application/presentation/add_address_screen/models/add_address_model.dart';import 'package:flutter/material.dart';class AddAddressController extends GetxController {TextEditingController oldPasswordController = TextEditingController();
...
@override void onClose() { super.onClose(); oldPasswordController.dispose(); oldPasswordOneController.dispose(); oldPasswordTwoController.dispose(); oldPasswordThreeController.dispose(); oldPasswordFourController.dispose(); oldPasswordFiveController.dispose(); oldPasswordSixController.dispose(); oldPasswordSevenController.dispose(); oldPasswordEightController.dispose(); } 
 }
